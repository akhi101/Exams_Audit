...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        [HttpPost, ActionName("UpdateUserdata")]
        public string UpdateUserdata([FromBody] JsonObject request)
        {
            try
            {
                ...
                param[1] = new SqlParameter("@StudentPhoneNumber", request["StudentPhoneNumber"]);
                param[2] = new SqlParameter("@Otp", request["OTP"]);
        ...
        public HttpResponseMessage SetOdcData([FromBody] OdCRequest OdCRequest)
        {
            try
            {
                ...
                AadharData = Aadhar;
               // $scope.Aadhaar = window.atob(CategoryDetails.AadharNumber)
                var dbHandler = new dbHandler();
                var param = new SqlParameter[8];
        ...
        public string GenerateOtpForMobileNoUpdate(string Pin, string Phone)
        {
            ...
            try
            {
                ...
                if (Phone != null || Phone != string.Empty)
                {
                    var textBytes = Encoding.UTF8.GetBytes(dt.Tables[0].Rows[0]["otp"].ToString());
                    ...
                    HttpResponseMessage response = client.GetAsync(urlParameters).Result;
                    resp = "OTP sent to the mobile number :" + Phone.ToString().Substring(0, 2) + "xxxxx" + Phone.ToString().Substring(7);
                    return "{\"status\":\"200\",\"description\" : \"" + resp + "\",\"otp\" : \"" + base64String + "\"}";
