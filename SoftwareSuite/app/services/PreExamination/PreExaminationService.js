define(['app'], function (app) {
    app.service("PreExaminationService", function (DataAccessService) {
        ...
        this.ValidateCaptcha = function (SessionId, Captcha, Pin, StudentTypeId, EMYR) {
            var paramObject = {
                "SessionId": SessionId, "Captcha": Captcha, "Pin": Pin,
                "StudentTypeId": StudentTypeId, "EMYR": EMYR
            };
            return DataAccessService.postData('api/PreExamination/ValidateCaptcha', paramObject);
        };
        ...
        this.ValidateGenuineCaptchaText = function (SessionId, Captcha, pin) {
            var paramObject = {
                "SessionId": SessionId, "Captcha": Captcha, "pin": pin
            };
            return DataAccessService.postData('api/AdminService/ValidateGenuineCaptchaText', paramObject);
        };

        this.ValidateAttendanceCaptcha = function (SessionId, Captcha, Pin) {
            var paramObject = {
                "SessionId": SessionId, "Captcha": Captcha, "Pin": Pin
            };
            return DataAccessService.postData('api/AdminService/ValidateAttendanceCaptcha', paramObject);
        };

        this.ValidateHtCaptcha = function (SessionId, Captcha, Pin, DateOfBirth, StudentTypeId, EMYR) {
            if (StudentTypeId == 1) {
                var paramObject = { "SessionId": SessionId, "Captcha": Captcha, "Pin": Pin, "Pin": Pin, "DateOfBirth": DateOfBirth, "StudentTypeId": StudentTypeId, "EMYR": EMYR };
                var promise = DataAccessService.postData('api/AdminService/ValidateHtCaptcha', paramObject);
                return promise;
            } else if (StudentTypeId == 2) {
                var paramObject = { "SessionId": SessionId, "Captcha": Captcha, "Pin": Pin, "Pin": Pin, "DateOfBirth": DateOfBirth, "StudentTypeId": StudentTypeId, "Exammonthyearid": EMYR };
                var promise = DataAccessService.postData('api/AdminService/ValidateHtCaptcha', paramObject);
                return promise;
            }
        },
        ...
        this.UpdateUserdata = function (Pin, StudentPhoneNumber, OTP) {
            ...
            return DataAccessService.postData('api/PreExamination/UpdateUserdata', param);
        };
