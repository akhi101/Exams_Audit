define(['app'], function (app) {
    app.service("ForgetPasswordService", function (DataAccessService) {
        ...
        this.GetForgetPassword = function (SysUserID, NewPassword) {
            var paramObject = { "SysUserID": SysUserID,"NewPassword": NewPassword };
            var promise = DataAccessService.getDataWithPara('api/SystemUser/GetChangePassword', paramObject);
            return promise;
        }
