                    ...
                    s2sresponsedata.then(function (res) {
                        ...
                        if (res.Table.length > 0) {
                            ...
                            if (res.Table[0].authstatus == '0300') {
                                $scope.success = true;
                                $scope.pins = pins;
								$scope.Status ="Transaction Successful"
                                ...
                                //$scope.Status = desc;
                                $scope.Status = "Payment Failed. Please, pay Fees again to download Hall Ticket with in due date. If amount Deducted from you Bank account it will be refunded with in 7 working Days";
                                $scope.LoadpaymentImg = false;
                                $scope.pins = pins;
                                $scope.success = false;
                                $scope.cancel();
