define(['app'], function (app) {
    ...
    app.controller("BranchWiseController", function ($http, $scope, $state, $stateParams, AppSettings,SystemUserService, MenuService,StudentWiseService, BranchWiseService, Excel, $timeout) {
        ...
        //},
            $scope.Submit = function () {
                ...
                if ($scope.scheme === '5') {
                    ...
                    var ResultData = BranchWiseService.GetBranchWiseReport(collegeid, $scope.scheme, $scope.sem, $scope.exam.examtypeid, $scope.branch);
                    ...
                    $scope.exam = JSON.parse($scope.examtype);
                    var ResultData = BranchWiseService.GetBranchWiseOldReport(collegeid, $scope.scheme, $scope.sem, $scope.exam.examtypeid, $scope.branch);
                    ResultData.then(function (data) {
