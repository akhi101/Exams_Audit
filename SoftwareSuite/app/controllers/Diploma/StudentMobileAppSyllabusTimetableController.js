define(['app'], function (app) {
    app.controller("StudentMobileAppSyllabusTimetableController", function ($scope, $http, $localStorage, $state, $stateParams, AppSettings, StudentResultService, PreExaminationService) {
        $scope.TimeTablepdf =null;
        $scope.TimeTableexcel =null
                    ...
                    if (data.length > 0) {
                        if (data.length > 4) {
                          ...
                          //  window.location.href = location;
                            ...
                            var excelurl = window.location.origin + location;
                            window.location.replace(excelurl);
                           // $scope.TimeTableexcel =excelurl;
