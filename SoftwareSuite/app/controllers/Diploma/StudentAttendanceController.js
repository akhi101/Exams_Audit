define(['app'], function (app) {
    app.controller("StudentAttendanceController", function ($scope, $http, $localStorage, $state, $window, PreExaminationService, $stateParams, AppSettings, $uibModal, AdminService ,AcademicService) {
...
/// recaptcha
     //   $scope.SessionCaptcha = sessionStorage.getItem('SessionCaptcha')
        ...
        var captcha1 = PreExaminationService.GetCaptchaString($scope.SessionCaptcha);
        captcha1.then(function (response) {
            try {
        ...
        $scope.ValidateAttendanceCaptcha = function () {
            ...
            var captcha = PreExaminationService.ValidateAttendanceCaptcha($scope.SessionCaptcha, $scope.CaptchaText, $scope.Studentpin);
