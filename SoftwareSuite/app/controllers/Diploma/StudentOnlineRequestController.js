define(['app'], function (app) {
    app.controller("StudentOnlineRequestController", function ($scope, $http, $localStorage, $window, $state, $stateParams, AppSettings, $uibModal, $timeout, AdminService, PaymentService, PreExaminationService) {
        ...
        $scope.ValidateCaptchaText = function (Pin, StudtypeId) {
            ...
            if ($scope.PinNumber.length > 9 && $scope.PinNumber.length <16) {
                ...
                GetPinStatus.then(function (res) {
                   ...
                   // $scope.createCaptcha();
                    ...
                    if (response.Table[0].ResponceCode == '200' || response.Table[0].ResponceCode == '400' || response.Table[0].ResponceCode == '401') {
