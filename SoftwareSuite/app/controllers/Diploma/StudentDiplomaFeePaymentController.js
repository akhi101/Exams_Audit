define(['app'], function (app) {
    app.controller("StudentDiplomaFeePaymentController", function ($scope, $http, $localStorage,$stateParams, $window, $state, PreExaminationService, $uibModal, PaymentService) {
        ...
        $ctrl.$onInit = () => {
            ...
            $scope.getStudentDetails($scope.pinNumber,$scope.Student.id)
        ...
        $scope.Proceedtopayfine = function () {
            ...
            try {
                College_Code = authData.College_Code == null ? "Mobile" : authData.College_Code;
            } catch (err) {
            }
