define(['app'], function (app) {
    app.controller("StudentConsolidatedResultController", function ($scope, $http, $localStorage, PreExaminationService, $window, $state, AdminService, AppSettings, StudentResultService, Excel, $timeout) {
