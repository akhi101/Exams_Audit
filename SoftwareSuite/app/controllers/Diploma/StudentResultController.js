define(['app'], function (app) {
    app.controller("StudentResultController", function ($scope, $http, $localStorage, $state, AppSettings, AdminService, StudentResultService, PreExaminationService,Excel, $timeout) {
        $scope.examtype = "";
        $scope.sem = "";
