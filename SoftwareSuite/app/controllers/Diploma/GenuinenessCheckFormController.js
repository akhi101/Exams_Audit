﻿define(['app'], function (app) {
     app.controller("GenuinenessCheckFormController", function ($scope, $http, $localStorage, $state, AdminService , $window, $stateParams, AppSettings, PreExaminationService, PaymentService, $uibModal) {
        $scope.Certificate = 8;
        ...
        $scope.ValidateCaptchaText = function (PinNumber) {
            ...
            var captcha = PreExaminationService.ValidateGenuineCaptchaText($scope.SessionCaptcha, $scope.CaptchaText, $scope.PinNumber);
